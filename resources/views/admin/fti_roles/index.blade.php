...
<style>
    ...
    @media (max-width: 768px) {
        ...
        tr { margin-bottom: 15px; box-shadow: 0 1px 4px rgba(0,0,0,0.1); border-radius: 6px; }
        th { display: none; }
        td { display: flex; justify-content: space-between; padding: 10px; border: none; }
        td::before { content: attr(data-label); font-weight: bold; color: #4CAF50; }
    }
</style>
