...
<div class="row mb-3">
    <div class="col-12">
        <div class="kp-tabs">
            ...
            <a href="{{ url('/mbkm/pendaftaran-nonmitra-mhs') }}" class="kp-tab">Pendaftaran MBKM</a>
            <a href="{{ url('/mbkm/pelaksanaan-nonmitra-mhs')}}" class="kp-tab active">Pelaksanaan MBKM</a>
            ...
            <div class="col-md-6">
                <div class="d-flex align-items-center mb-3">
                    <div>
                        ...
                        <h6 class="fw-bold mb-0">{{ $approvedMbkm->nama_perusahaan ?? 'N/A' }}</h6>
                    </div>
                </div>
...
<div class="modal fade" id="tambahLogModal" tabindex="-1" aria-labelledby="tambahLogModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('mbkm.store.pelaksanaan-nonmitra') }}" method="POST">
                @csrf
