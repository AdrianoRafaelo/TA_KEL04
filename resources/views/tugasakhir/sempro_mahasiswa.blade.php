...
@section('content')
    ...
    <div class="row">
      <div class="col-md-6">
        <table class="table table-borderless mb-0">
          <tr>
            <th>Nama/NIM</th>
            <td>Hansel Septiyan Pasaribu / 21S20023</td>
          </tr>
          <tr>
            <th>Judul Penelitian</th>
            <td>Desain Sistem Informasi Pengelolaan Informasi dan Administrasi Program Studi Manajemen Rekayasa</td>
          </tr>
        </table>
      </div>
      <div class="col-md-6">
        <table class="table table-borderless mb-0">
          ...
          <tr>
            ...
            <td><span class="btn btn-warning btn-sm">Diterima</span></td>
          </tr>
        </table>
      </div>
    </div>
  ...
  <div class="section-container">
    ...
    <div class="section-left">
      ...
      <div class="card">
        <div class="card-body">
          <span class="kp-list-title"> Seminar</span>
  ...
  <header class="mb-4">
    <nav class="text-sm font-medium text-gray-500 mb-2" aria-label="breadcrumb">
      <ol class="flex space-x-2">
        ...
        <li><a href="#" class="hover:text-blue-600">Tugas Akhir</a><span class="mx-2">/</span></li>
        <li>Seminar Proposal</li>
      </ol>
    </nav>

    <h5 class="fw-semibold mb-2">Seminar Proposal</h5>
    <nav class="kp-tabs">
      <a href="{{ url('/ta-mahasiswa') }}" class="kp-tab">Pendaftaran TA</a>
      <a href="{{ route('seminar.proposal.mahasiswa') }}" class="kp-tab active">Seminar Proposal</a>
      <a href="#" class="kp-tab disabled">Seminar Hasil</a>
      <a href="#" class="kp-tab disabled">Sidang Akhir</a>
      <a href="#" class="kp-tab disabled">Bimbingan</a>
    </nav>
  </header>
