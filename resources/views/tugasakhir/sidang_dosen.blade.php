    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="kp-tabs d-flex flex-wrap gap-2">
                ...
                <button class="kp-tab active">Sidang Akhir</button>
        ...
        <table class="table align-middle mb-0">
            ...
            <tbody style="font-size:14px; color:#111;">
                ...
                <tr class="hover-row">
                    ...
                    <td>
                        @if($assignment->sidangAkhir && $assignment->sidangAkhir->file_dokumen_ta)
                            <a href="{{ asset('storage/' . $assignment->sidangAkhir->file_dokumen_ta) }}" target="_blank" class="text-primary"><i class="fas fa-file-pdf"></i> Dokumen</a>
                        @else
                            Belum upload
                        @endif
                    </td>
                    <td>
                        @if($assignment->sidangAkhir && $assignment->sidangAkhir->berita_acara_pembimbing)
                            <a href="{{ asset('storage/' . $assignment->sidangAkhir->berita_acara_pembimbing) }}" target="_blank" class="text-primary"><i class="fas fa-file-pdf"></i> Lihat</a>
                        @else
                            -
                        @endif
                    </td>
                    <td>
                        @if($assignment->sidangAkhir && $assignment->sidangAkhir->penilaian_pembimbing)
                            <a href="{{ asset('storage/' . $assignment->sidangAkhir->penilaian_pembimbing) }}" target="_blank" class="text-primary"><i class="fas fa-file-pdf"></i> Lihat</a>
                        @else
                            -
                        @endif
                    </td>
                ...
                <tr class="hover-row">
                    ...
                    <td>
                        @php
                            ...
                            $beritaAcara = $isPengulas1 ? $assignment->sidangAkhir->berita_acara_pengulas1 : $assignment->sidangAkhir->berita_acara_pengulas2;
                        @endphp
                        @if($assignment->sidangAkhir && $beritaAcara)
                    ...
                    <td>
                        @php
                            $penilaian = $isPengulas1 ? $assignment->sidangAkhir->penilaian_pengulas1 : $assignment->sidangAkhir->penilaian_pengulas2;
                        @endphp
                        @if($assignment->sidangAkhir && $penilaian)
