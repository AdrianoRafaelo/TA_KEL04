...
<meta name="csrf-token" content="{{ csrf_token() }}">
  ...
  <div class="section-container">
    ...
    <div class="section-left">
      ...
      <div class="card">
        <div class="card-body">
          <span class="kp-list-title">Informasi Sidang</span>
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center">
              <span>Unduh Jadwal</span>
              @if($mahasiswaTa && $mahasiswaTa->sidangAkhir && $mahasiswaTa->sidangAkhir->jadwal_sidang_file)
                <button class="btn btn-sm btn-outline-primary view-file-btn" data-file-url="{{ route('storage.file', ['path' => $mahasiswaTa->sidangAkhir->jadwal_sidang_file]) }}" data-file-name="Jadwal Sidang">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
              ...
              @if($mahasiswaTa && $mahasiswaTa->sidangAkhir && $mahasiswaTa->sidangAkhir->rubrik_penilaian)
                <button class="btn btn-sm btn-outline-primary view-file-btn" data-file-url="{{ route('storage.file', ['path' => $mahasiswaTa->sidangAkhir->rubrik_penilaian]) }}" data-file-name="Rubrik Penilaian">
                  <i class="bi bi-file-pdf"></i> Lihat
                </button>
              @else
                <span class="text-muted">Belum tersedia</span>
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
              ...
              @if($mahasiswaTa && $mahasiswaTa->sidangAkhir && $mahasiswaTa->sidangAkhir->form_review)
                <button class="btn btn-sm btn-outline-primary view-file-btn" data-file-url="{{ route('storage.file', ['path' => $mahasiswaTa->sidangAkhir->form_review]) }}" data-file-name="Form Review">
                  <i class="bi bi-file-pdf"></i> Lihat
                </button>
              @else
                <span class="text-muted">Belum tersedia</span>
...
$(document).ready(function() {
  ...
  $('.edit-file-btn').click(function(e) {
    ...
    $('#editFileForm').attr('action', '/sidang-akhir-mahasiswa/update-file/' + field);
  ...
  $('#confirmDeleteBtn').click(function() {
    ...
    const form = $('<form>', {
      method: 'POST',
      action: '/sidang-akhir-mahasiswa/delete-file/' + field
    });
