...
<div class="container-fluid py-3">
    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <h4 class="mb-0">Seminar Hasil</h4>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="kp-tabs d-flex flex-wrap gap-2">
                ...
                <button class="kp-tab active">Seminar Hasil</button>
        ...
        <table class="table align-middle mb-0">
            ...
            <tbody style="font-size:14px; color:#111;">
                ...
                <tr class="hover-row">
                    ...
                    <td>
                        @if($assignment->seminarHasil && $assignment->seminarHasil->file_dokumen_ta)
                            <a href="{{ asset('storage/' . $assignment->seminarHasil->file_dokumen_ta) }}" target="_blank" class="text-primary"><i class="fas fa-file-pdf"></i> Dokumen</a>
                        @else
                            Belum upload
                        @endif
                    </td>
