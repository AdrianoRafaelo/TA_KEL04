        ...
        <table class="table align-middle mb-0">
            ...
            <tbody style="font-size:14px; color:#111;">
                ...
                <tr class="hover-row">
                    ...
                    <td>
                        @if($assignment->seminarProposal && $assignment->seminarProposal->berita_acara_pembimbing)
                            <a href="{{ asset('storage/' . $assignment->seminarProposal->berita_acara_pembimbing) }}" target="_blank" class="text-primary"><i class="fas fa-file-pdf"></i> Lihat</a>
                        @else
                            -
                        @endif
                    </td>
                    <td>
                        @if($assignment->seminarProposal && $assignment->seminarProposal->penilaian_pembimbing)
                            <a href="{{ asset('storage/' . $assignment->seminarProposal->penilaian_pembimbing) }}" target="_blank" class="text-primary"><i class="fas fa-file-pdf"></i> Lihat</a>
                        @else
                            -
                        @endif
                    </td>
                ...
                <tr class="hover-row">
                    ...
                    <td>
                        @php
                            ...
                            $beritaAcara = $isPengulas1 ? $assignment->seminarProposal->berita_acara_pengulas1 : $assignment->seminarProposal->berita_acara_pengulas2;
                        @endphp
                        @if($assignment->seminarProposal && $beritaAcara)
                    ...
                    <td>
                        @php
                            $penilaian = $isPengulas1 ? $assignment->seminarProposal->penilaian_pengulas1 : $assignment->seminarProposal->penilaian_pengulas2;
                        @endphp
                        @if($assignment->seminarProposal && $penilaian)
